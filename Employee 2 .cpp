...
int main()
{
	...
	for (int i = 0; i < 10; i++)
	{
		v.push_back(new SalariedEmployee(Name(), Name(), socialCode(), rand() % 9001 + 1000));
	}
	for (int i = 0; i < 10; i++)
	{
		v.push_back(new CommissionEmployee(Name(), Name(), socialCode(), rand() % 9001 + 1000, (rand() % 401) / 1000.0 + 0.1));
	}
	for (int i = 0; i < 10; i++)
	{
		v.push_back(new BasePlusCommissionEmployee(Name(), Name(), socialCode(), rand() % 9001 + 1000, (rand() % 401) / 1000.0 + 0.1,
			rand() % 9001 + 1000));
	}
